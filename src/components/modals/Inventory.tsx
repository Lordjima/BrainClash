        ...
        {selectedItem && (
          ...
          >
            ...
            <div className="mt-auto pt-6 space-y-3">
              ...
              <button className="w-full flex justify-center items-center gap-2 bg-zinc-800 text-zinc-500 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all hover:bg-red-500/10 hover:text-red-500 border border-transparent hover:border-red-500/20">
