...
import { ShoppingBag, Package, Zap, Shield, Heart, Info, Star, Trash2, Play, Coins } from 'lucide-react';
...
export default function InventoryModal({ isOpen, onClose }: InventoryModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="max-w-5xl" className="p-0 flex flex-col overflow-hidden h-[90vh]">
      {/* Header */}
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {inventoryItems.map((item, idx) => (
                <div
                  ...
                  className={`aspect-square rounded-3xl bg-zinc-950/50 border-2 p-4 flex flex-col items-center justify-center gap-3 cursor-pointer transition-all group hover:scale-105 hover:-translate-y-1 active:scale-95 ${
        ...
        {selectedItem && (
          <div
            className="w-full md:w-80 bg-zinc-950/50 border-l border-zinc-800 p-8 flex flex-col gap-8 overflow-y-auto custom-scrollbar animate-in slide-in-from-right-8"
          >
            ...
            <div className="mt-auto pt-6 space-y-3">
              <Button variant="gradient" className="w-full" icon={<Play className="w-4 h-4 fill-current" />}>
                ÉQUIPER
              </Button>
